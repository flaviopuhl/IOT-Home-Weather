...
DeserializationError error = deserializeJson(doc, input);
          ...
          //const char* alerts_0_tags_0 = alerts_0["tags"][0]; // "Wind"
              ...
              Serial.println(F("############### Current OpenWeatherMap ###############\n"));
//              Serial.print("Current_dt       : "); Serial.println(strTime(current_dt)); 
              Serial.print(F("Current_temp     : ")); Serial.println(current_temp);
              Serial.print(F("Current_eels_like: ")); Serial.println(current_feels_like);
              //Serial.print(F("Current_weather  : ")); Serial.println(current_weather_0_id);
...
//                        Current_dt=strTime(current_dt).substring(0, 10);
              ...
              Serial.println(F(" "));Serial.println(F(" "));
              Serial.println(F("############### Forecast Tomorrow OpenWeatherMap ###############\n"));
//              Serial.print("Tomorrow_dt       : "); Serial.println(strTime(daily_1_dt));
              Serial.print(F("Tomorrow_temp_max : ")); Serial.println(daily_1_temp_max);
              Serial.print(F("Tomorrow_temp_min : ")); Serial.println(daily_1_temp_min);
              //Serial.print(F("Tomorrow_weather  : ")); Serial.println(daily_1_weather_0_id);
...
//                        Tomorrow_dt=strTime(daily_1_dt).substring(0, 10);
              ...
              Serial.println(F(" "));Serial.println(F(" "));
              Serial.println(F("############### Forecast Day After Tomorrow OpenWeatherMap ###############\n"));
//              Serial.print("DayAftTmw_dt    : "); Serial.println(strTime(daily_2_dt));
              Serial.print(F("DayAftTmwtempmax: ")); Serial.println(daily_2_temp_max);
              Serial.print(F("DayAftTmwtempmin: ")); Serial.println(daily_2_temp_min);
              //Serial.print(F("Tomorrow_weather  : ")); Serial.println(daily_2_weather_0_id);
